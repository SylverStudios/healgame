...
describe('CARD_UNLOCKS (§3 table)', () => {
  ...
  it('encodes the handoff §3 unlock rows exactly', () => {
...
describe('unlocksAtOrBelowLevel / spellIdsAtLevel / cooldownIdsAtLevel', () => {
  ...
  it('levels 6–8 unlock one major CD each', () => {
    expect(cooldownIdsAtLevel(6)).toEqual(['still-waters']);
    expect(cooldownIdsAtLevel(7)).toEqual(['still-waters', 'wrath-ascendant']);
